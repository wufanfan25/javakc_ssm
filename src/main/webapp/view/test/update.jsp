		...
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox float-e-margins">
				<form action="${path }/test/update.do" method="post" class="form-horizontal" role="form">
                    <input id="testId" name="testId" type="hidden" value="${testEntity.testId}">
                    <fieldset>
                        <legend>测试模块基本信息---修改</legend>
                       <div class="form-group">
                          <label class="col-sm-2 control-label" for="ds_host">名称</label>
                          <div class="col-sm-4">
                             <input class="form-control" type="text" name="testName" value="${testEntity.testName}" placeholder="名称"/>
                          </div>
                          <label class="col-sm-2 control-label" for="ds_name">性别</label>
                          <div class="col-sm-4">
                              <zhg:select codeTp="sex" name="testSex" value="${testEntity.testSex}" cls="form-control" def="true" ></zhg:select>
                          </div>
                       </div>
                       <div class="form-group">
